                    ...
                    <tbody>
                      <?php foreach($groupes as $row){ ?>
                        <tr>
                          ...
                          <td class="d-flex">
                              <form action="http://localhost/www/brief_6_VueJs_API/rendez_vous/update" method="post">
                                <input type="hidden" name="DeleteID" value="<?php echo $row['id']?>">
                                <button name="submit" class="btn btn-warning">Update</button>
                              </form>
                              <form action="http://localhost/www/brief_6_VueJs_API/rendez_vous/delete" method="post">
                                <input type="hidden" name="DeleteID" value="<?php echo $row['id']?>">
